- ============================================================
-- ShopEase Database - Data & Analysis Queries
-- CEI SQL Task 2, Week 2
-- ============================================================
...
-- Q10: Orders between Aug 10-25 (excluding cancelled)
SELECT * FROM orders
WHERE order_date BETWEEN '2024-08-10' AND '2024-08-25'
AND status != 'Cancelled';

-- Q11: Orders on a specific date
SELECT * FROM orders
WHERE order_date = '2024-08-15';

-- Q12: All customers who joined in 2024
SELECT * FROM customers
WHERE join_date BETWEEN '2024-01-01' AND '2024-12-31';


-- ============================================================
-- SECTION 4: AGGREGATIONS (GROUP BY)
-- ============================================================
...
-- Q18: Categories with avg price above Rs.2000
SELECT category,
       AVG(unit_price) AS avg_price
FROM products
GROUP BY category
...
-- Q27: Place a new order safely using transaction
START TRANSACTION;
